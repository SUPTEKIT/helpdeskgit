<?php if(isset($_SESSION['nombre']) && isset($_SESSION['tipo'])){
   $DateAndTime = date('m-d-Y h:i:s a', time());     
        ...
        if(isset($_POST['fecha_ticket']) && isset($_POST['name_ticket']) && isset($_POST['email_ticket'])){
          ...
          $cabecera="From: Suptek IT Quito-Ecuador<compuexpressit@gmail.com>";
                        ...
                        <div class="form-group">
                            ...
                            <div class='col-sm-10'>
                                <div class="input-group">
                                    <input class="form-control" type="text" value="<?php echo" $DateAndTime"?>" placeholder="" name="fecha_ticket" required="" readonly >
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-7 text-center">
                <h1 class="text-danger">Lo sentimos esta página es solamente para usuarios registrados en Suptek IT</h1>
